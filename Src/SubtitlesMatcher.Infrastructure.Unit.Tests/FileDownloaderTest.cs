...
namespace SubtitlesMatcher.Infrastructure.Unit.Tests
{
    ...
    public class FileDownloaderTest
    {
        ...
        {
            string url = @"http://www.subscenter.org/download.php?subId=58186";
            string targetFilePath = @"C:\Users\offir\Documents\Downloads\res.zip";
            FileDownloader.Download(url, targetFilePath);
